...
*/
Cssjs.prototype.stripComments = function(cssString) {
...
/*
  ...
  @return object css
*/
Cssjs.prototype.parseCSS = function(source) {
...
/*
  ...
  @param rules, css directive string example
      \n\ncolor:white;\n    font-size:18px;\n
*/
Cssjs.prototype.parseRules = function(rules) {
...
*/
Cssjs.prototype.findCorrespondingRule = function(rules, directive, value) {
  if (value === undefined) {
    value = false;
  }
  var ret = false;
...
/*
    ...
    and returns them
*/
Cssjs.prototype.findBySelector = function(cssObjectArray, selector, contains) {
...
*/
Cssjs.prototype.deleteBySelector = function(cssObjectArray, selector) {
  var ret = [];
  for (var i = 0; i < cssObjectArray.length; i++) {
    if (cssObjectArray[i].selector !== selector) {
...
/*
    ...
    selector redundence.
*/
Cssjs.prototype.compressCSS = function(cssObjectArray) {
  var compressed = [];
  var done = {};
  for (var i = 0; i < cssObjectArray.length; i++) {
...
*/
Cssjs.prototype.cssDiff = function(css1, css2) {
...
*/
Cssjs.prototype.intelligentMerge = function(cssObjectArray, newArray, reverse) {
...
*/
Cssjs.prototype.intelligentCSSPush = function(cssObjectArray, minimalObject, reverse) {
...
*/
Cssjs.prototype.compactRules = function(rules) {
  var newRules = [];
  for (var i = 0; i < rules.length; i++) {
...
*/
Cssjs.prototype.getCSSForEditor = function(cssBase, depth) {
  if (depth === undefined) {
    depth = 0;
  }
  var ret = '';
...
Cssjs.prototype.getImports = function(cssObjectArray) {
  var imps = [];
  for (var i = 0; i < cssObjectArray.length; i++) {
...
*/
Cssjs.prototype.getCSSOfRules = function(rules, depth) {
  var ret = '';
  for (var i = 0; i < rules.length; i++) {
...
*/
Cssjs.prototype.getSpaces = function(num) {
  var ret = '';
...
*/
Cssjs.prototype.applyNamespacing = function(css, forcedNamespace) {
...
*/
Cssjs.prototype.clearNamespacing = function(css, returnObj) {
...
*/
Cssjs.prototype.createStyleElement = function(id, css, format) {
  if (format === undefined) {
    format = false;
  }
